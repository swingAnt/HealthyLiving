...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: "/static/tabbar/basics" + [$data.PageCur == "component" ? "_cur" : ""] + ".png",
    h: common_vendor.n($data.PageCur == "component" ? "text-green" : "text-gray"),
    i: common_vendor.o((...args) => $options.NavChange && $options.NavChange(...args)),
    j: "/static/tabbar/plugin" + [$data.PageCur == "plugin" ? "_cur" : ""] + ".png",
    k: common_vendor.n($data.PageCur == "plugin" ? "text-green" : "text-gray"),
    l: common_vendor.o((...args) => $options.NavChange && $options.NavChange(...args))
  };
}
